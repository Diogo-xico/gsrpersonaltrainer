    ...
    <div class="container contentor p-5">
        <div class="row linha g-0 shadow">
            <div class="formulario-registar col-lg-5 p-5 bg-dark">
                ...
                <form  name="formregisto" 
                    action="ajax/registoUtilizador.php" method="POST">
                    ...
                    <div  class="form-row col-lg-7">
                        <input name="idade" type="number" min="10" max="120" placeholder="Idade" class="form-control my-3">
                    </div>
