        ...
        if (isset($_SESSION['logged']) && $_SESSION['logged'] == 1) { ?>
            ...
            <div class="row ">
                <div class="col-12 col-lg-6 p-3 text-center">
                    <div class="titulo-transformacoes pt-5 pb-5 ">Dados de Envio</div>
                    <div class="pb-3 fs-3">Nome: <?= $inf->nome ?> <?= $inf->sobrenome ?></div>
                    <div class="pb-3 fs-3">Morada: <?= $inf->morada ?></div>
                    <div class="pb-3 fs-3">Localidade: <?= $inf->localidade ?></div>
                    <div class="pb-3 fs-3">Código-Postal: <?= $inf->codigoPostal ?></div>
                    <div class="pb-3 fs-3">Email: <?= $inf->email ?></div>
                </div>
                <div class="col-12 col-lg-6 p-3">
                    <div class="titulo-transformacoes text-center pt-5 pb-5">Resumo</div>
                            ...
                            <div class="d-flex justify-content-between mb-1 fs-4">
                                <div class="mx-1">
                                    <form action="ajax/removerCarrinho.php" method="post">
                                        ...
                                        <?php } ?>
                                        <span class="fs-6">
                                            QTD: <?= $carrinho['quantidadeproduto'] ?>
                                        </span>
                                    </form>
                                </div>
                    ...
                    ?>
                        <div class="d-flex justify-content-center mt-4">
                            <div class="col-4"></div>
                            <div class="col-4" data-bs-toggle="modal" data-bs-target="#confirmarEncomenda"> 
                                <button class="btn1">Finalizar</button>
                            </div>
                            <div class="col-4"></div>
                        </div>
