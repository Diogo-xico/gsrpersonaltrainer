...
<body id="body-artigo">
    ...
    <main>
        ...
        <div class="container contentor py-5">
            <div class="row my-5 py-5">
                <?php if (($artigo->categoria) === 1) { ?>
                    <div class="col-12 col-sm-12 col-md-6 col-lg-4 d-flex align-items-center mx-auto">
                        <img class="img-fluid rounded artigos" src="imagens/produtos/<?= $artigo->imagem ?>"
                            alt="<?= $artigo->nome ?>" style="width: 350px">
                    </div>
                <?php } else { ?>
                    <div class="col-12 col-sm-12 col-md-6 col-lg-4 d-flex align-items-center mx-auto">
                        <img class="img-fluid rounded artigos" src="imagens/produtos/<?= $artigo->imagem ?>"
                ...
                <div class="col-12 col-sm-12 col-md-6 mx-auto">
                    ...
                    <h4 class="my-3">Detalhes do produto</h4>
                    <span>
                        <?= $artigo->descricao ?>
                    </span>
                    ...
                    <form action="ajax/adicionaCarrinho.php" method="POST">
                        ...
                        <h6 class="mt-2 mb-1">Quantidade:</h6>
                        <input type="number" value="1" name="quantidadeProduto" min="1" class="btn border-0 my-2 w-50"
                            style="background: #efefef">
                        <div>
                            <button type="submit" class="btn-artigo-selec border-0 mt-2 w-50">
